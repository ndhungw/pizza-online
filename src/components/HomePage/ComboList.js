...
function ComboItem(props){
    ...
    return(
        <div style={{width:'100%',height:'100%',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'flex-start'}}>
            <img src={combo.img} alt={combo.title} style={{width:'70%',height:'55%'}}/>
            <div style={{width:'70%',height:'15%',display:'flex',flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
                <p style={{fontWeight: 'bold',fontSize:16,marginRight:'20%',textAlign:'start',color:textColor,flexWrap:'wrap'}} >{combo.title}</p>
            ...
            <div style={{width:'70%',height:'30%',display:'flex',flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                <ButtonBase>
                    <div style={{borderRadius:20,paddingVertical:10,paddingInline:20,backgroundColor:'#ee3'}}>
...
export default function ComboList(props) {
    ...
    return (
        <div className={classes.root}>
            <span style={{backgroundColor:backgroundColor,flexDirection:'column',alignItems:'center',justifyContent:'center',marginLeft:'5%',width:'40%',borderTopLeftRadius:20,borderTopRightRadius:20}} >
