    ...
    return(
        <Grid container item xs={12} style={{width:"100px"}}>
            ...
            <SvgIcon style={{width: "20px"}} viewBox="0 0 324 324" fill="none" onClick={setIncrementValue}>
                <path d="M162 0C72.6678 0 0 72.6678 0 162C0 251.332 72.6678 324 162 324C251.332 324 324 251.32 324 162C324 72.6804 251.332 0 162 0ZM162 298.903C86.5213 298.903 25.0967 237.491 25.0967 162C25.0967 86.5086 86.5213 25.0967 162 25.0967C237.479 25.0967 298.903 86.5086 298.903 162C298.903 237.491 237.491 298.903 162 298.903Z" fill="white"/>
                <path d="M224.742 148.322H174.549V98.129C174.549 91.2022 168.94 85.5803 162 85.5803C155.061 85.5803 149.452 91.2022 149.452 98.129V148.322H99.2581C92.3187 148.322 86.7095 153.944 86.7095 160.871C86.7095 167.798 92.3187 173.42 99.2581 173.42H149.452V223.613C149.452 230.54 155.061 236.162 162 236.162C168.94 236.162 174.549 230.54 174.549 223.613V173.42H224.742C231.682 173.42 237.291 167.798 237.291 160.871C237.291 153.944 231.682 148.322 224.742 148.322Z" fill="white"/>
            </SvgIcon>
        </Grid>
    );
}
