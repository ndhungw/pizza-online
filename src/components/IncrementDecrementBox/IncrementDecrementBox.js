...
const IncrementDecrementBox = ({...props}) => {
    const classes = useStyles();

    const [value, setValue] = useState(0);

    const setIncrementValue = () => {
        setValue(value < Number.MAX_SAFE_INTEGER ? value + 1 : Number.MAX_SAFE_INTEGER);
    }
    ...
    return(
        <Grid container item xs={12} justify='center' className={classes.parent} >
            <Grid container item xs={3} justify="center">
                <IconButton width={16} onClick={setDecrementValue}>
                    <SvgIcon width={16} viewBox="0 0 189 189" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Grid container item xs={3} justify="center">
                <IconButton width={16} onClick={setIncrementValue}>
                    <SvgIcon width={16} viewBox="0 0 324 324" fill="none" xmlns="http://www.w3.org/2000/svg">
