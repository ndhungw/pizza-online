...
export default function Tray({sizeOption, crustOption, setSizeOption, setCrustOption, setWeight}) {
  ...
  return (
    <Card class="tray">
        ...
        <Grid container xs={12}>
            <Grid xs={1}/>
            <Grid xs={3} >
                <SelectSize label="Kích cỡ"  sizeOption={sizeOption}  setSizeOption={setSizeOption} setPriceS={setPriceS} priceS={priceS}/>
            </Grid>
            <Grid xs={1}/>
            <Grid xs={3} >
                <SelectCrust  label="Đế bánh" crustOption={crustOption}  setCrustOption={setCrustOption} setPriceC={setPriceC} priceC={priceC} />
            </Grid>
            <Grid xs={3}>
        ...
        <Grid class="contentCenter" xs={12} style={{ fontSize:"20px"}}>
            <div><Table Ingredient={Ingredient} setIngredient={setIngredient} money={money} setMoney={setMoney} /></div>
        </Grid>
        <br/>
        <Grid container xs={12} style={{ fontSize:"20px"}}>
            <Grid xs={1}/>
        ...
        <br/>
        <Grid xs={12} style={{fontWeight: "bold", fontSize:"20px"}} class="contentCenter">
                <button style={{height: "40px", fontSize: "20px", borderRadius: "15px", backgroundColor: "#D2112D", color:'white', width: "full"}}>Thêm vào giỏ</button>
        </Grid>
        <br/>
    </Card>
  );
